...
;; Forked from upstream to fix execute permission issues with
;; newer Guix daemon sandboxes.
;;
;; Code:
    ...
    (if (file-exists? "setup.ml")
      (let ((args `("-configure"
       ...
       (let ((args `("-prefix" ,out ,@configure-flags)))
        ...
        (apply invoke "sh" "./configure" args))))
    #t)
...
(define %standard-phases
  ...
  (modify-phases gnu:%standard-phases
    (delete 'bootstrap)
    (add-after 'unpack 'fix-script-permissions fix-script-permissions)
