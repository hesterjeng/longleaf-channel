...
(define-public ocaml-ke
  (package
    ...
    (build-system dune-build-system)
    (propagated-inputs (list ocaml-fmt ocaml-bigstringaf))
    (native-inputs (list ocaml-alcotest))
...
(define-public ocaml-x509
  (package
    ...
    (build-system dune-build-system)
    (propagated-inputs (list ocaml-ohex ocaml-digestif ocaml-ptime ocaml-fpath ocaml-bos ocaml-ipaddr
                             ocaml-mirage-crypto ocaml-mirage-crypto-rng ocaml-kdf ocaml-gmap ocaml-asn1-combinators
                             ))
    (native-inputs (list gmp))
    (synopsis "")
    (description "")
...
(define-public ocaml-bigarray-overlap
  (package
    ...
    (native-inputs (list pkg-config ocaml-alcotest))
    (build-system dune-build-system)
    (synopsis "")
    (description "")
    (license license:expat)
